...
class ComboBruteManager:
    ...
    Supports both single and multi-GPU setups with true parallel execution.
    """
    ...
    def run(self):
        ...
        try:
            while not self.found_flag:
                ...
                # *** KORREKTUR: SCHRITT 1 - ALLE PROZESSE STARTEN ***
                ...
                # *** KORREKTUR: SCHRITT 2 - AUF ALLE WARTEN UND ERGEBNISSE SAMMELN ***
                ...
                if self.found_flag:
                    ...
                    # Beende alle noch laufenden Prozesse, falls ein Fund vorliegt
